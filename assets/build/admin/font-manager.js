...
"use strict";
module.exports = __webpack_require__.p + "630956c266e3be4f718d.wasm";
...
/******/ 			return "chunks/" + chunkId + "." + "6cf81353" + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
(function () {
  ...
  async function convertFontForPrint(fontId, button) {
    ...
    try {
      ...
      if (!json.success) {
        if (['OTF', 'WOFF', 'WOFF2'].includes(String(font.ext || '').toUpperCase())) {
  ...
  async function convertFontInBrowser(font) {
    ...
    try {
      ({
        createFont,
        woff2
      } = await __webpack_require__.e(/*! import() | font-conversion */ "font-conversion").then(__webpack_require__.bind(__webpack_require__, /*! fonteditor-core */ "./node_modules/fonteditor-core/lib/main.esm.js")));
    } catch (error) {
      throw new Error('Font conversion tools could not load. Check your connection and retry.', {
        cause: error
      });
    }
    if (sourceType === 'woff2') {
      const wasmUrl = new URL(/* asset import */ __webpack_require__(/*! ../../node_modules/fonteditor-core/woff2/woff2.wasm */ "./node_modules/fonteditor-core/woff2/woff2.wasm"), __webpack_require__.b);
