...
// [id, right ascension hours, declination degrees, magnitude]
const STARS = [
	...
	[ 'algenib', 0.2206, 15.1836, 2.84 ],
	[ 'sadr', 20.3705, 40.2567, 2.23 ],
	[ 'gienah', 20.7702, 33.9703, 2.48 ],
	[ 'albireo', 19.512, 27.9597, 3.05 ],
];
